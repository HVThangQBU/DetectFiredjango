...
# sender = imagezmq.ImageSender(connect_to='tcp://localhost:5566')
...
path = "rtsp://user:Admin123@camxathaitranquangkhai.ddns.net:554/profile2/media.smp"  # change to your IP stream address
